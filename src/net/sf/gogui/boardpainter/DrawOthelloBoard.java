 ...
 * @author Yan-Ru Ju
 */
public class DrawOthelloBoard extends DrawMeshBoard
{
    public DrawOthelloBoard(BoardStatus boardStatus, double[] v1, double[] v2)
    {
        super(boardStatus, v1, v2);
        m_grid = new DrawOthelloGrid(Color.BLACK, 1);
        m_square = new DrawSquareGrid(Color.BLACK, 1);
    }
    
    private DrawOthelloGrid m_grid;
