...
implements ConstBoard
{
    ...
    private static class StackEntry
    {
        ...
        public void execute(Board board)
        {
            ...
            //<modified>
            if (board.getRule() != null)
            {
                executeRule(board);
            }
            else if (board.isGameRulerAttached())	
            {	
                try {	
        ...
        //<modified>
        private void executeRule(Board board)
        {
            ...
            if (p != null)
            {
                ...
                board.setColor(p, c);
                List<Rule.Point> updateList = board.getRule().play(RuleUtil.goPointToRulePoint(p, c));
                if (updateList != null) 
                {
                    for (Rule.Point point : updateList)
                    {
                        board.setColor(RuleUtil.rulePointToGoPoint(point), RuleUtil.rulePointToGoColor(point));
                    }
                }
    ...
    public void setColor(GoPoint p, GoColor c)
    {
        assert p != null;
