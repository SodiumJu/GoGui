    ...
    implements ConstGuiBoard, Printable
{
    ...
    /** Constructor.
        ...
        @param  fieldFactory*/
    public GuiBoard(int size, FieldFactory fieldFactory)
    {
    ...
    public void initSize(int size)
    {
        ...
        removeAll();
        m_cursor = null;
        setLayout(new SquareLayout(m_painter.m_drawBoard.getScreenRatio()));
        ...
        for (int y = size - 1; y >= 0; --y)
            for (int x = 0; x < size; ++x)
                m_field[x][y] = m_fieldFactory.createField();
        m_lastMove = null;
        ...
        extends JPanel
    {
        ...
        public final void setPreferredFieldSize()
        {
            ...
            setPreferredSize(m_painter.getPreferredSize(preferredFieldSize,
                                                          m_size, m_showGrid));
    ...
    public final BoardPainter m_painter;
    
    private FieldFactory m_fieldFactory;
