    ...
    implements ActionListener
{
    ...
    public static ConditionPattern run(Frame owner, String initialValue,
                              MessageDialogs messageDialogs)
    {
        while (true)
        {
            ...
            String condition_regex = dialog.m_pattern;
            if (StringUtil.isEmpty(condition_regex))
                return null;
            try
            {
                return new ConditionPattern(condition_regex);
            }
            catch (Exception e)
            {
