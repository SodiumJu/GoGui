...
import net.sf.gogui.boardpainter.DrawOthelloBoard;
...
import net.sf.gogui.rule.Othello;
// <TODO>
...
public class GoGuiActions
{
    ...
    public final GuiAction m_actionOthello =
    new GuiAction(i18n("ACT_Othello")) {
        public void actionPerformed(ActionEvent e) {
            m_goGui.actionSetGame(new Othello(m_goGui.getGame().getSize()), new DrawOthelloBoard(m_goGui.getGuiBoard().getBoardPainter().m_boardStatus, new double[]{1, 0}, new double[]{ 0, 1}), new GoFieldFactory(), 8); } };
    // <TODO>
