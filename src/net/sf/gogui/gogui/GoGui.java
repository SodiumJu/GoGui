            ...
            ContextMenu.Listener, LiveGfx.Listener
{
    ...
    public void actionBackward(int n)
    {
        ...
        // if (m_rule != null){ // YR
        //     m_rule.reset(getBoardSize());
        //     var opening = m_rule.getOpening();
        //     m_rule.setEnabled(true);
        //     for(GoPoint act: opening)
        //         fieldClicked(act, false);
        ...
        else
        {
            ...
            if (m_rule != null)
            {
                ...
                /*if (!m_rule.isLegalMove(RuleUtil.goPointToRulePoint(p, getBoard().getColor(p))) && 
                    ...
                    return;*/  
                if (!m_rule.isLegalMove(RuleUtil.goPointToRulePoint(p, getToMove())) && 
                        !showQuestion(m_rule.getIllegalMoveMainMessage(), m_rule.getIllegalMoveoptionalMessage(), m_rule.getIllegalMoveDestructiveOption(),  false))
                    return;              
            }
            else
...
//    }
    ...
    private void drawRZone()
    {
        ...
        var curr_node = getCurrentNode();
        var sgf_prop = curr_node.getSgfPropertiesConst();
        if (sgf_prop == null)
            return;
